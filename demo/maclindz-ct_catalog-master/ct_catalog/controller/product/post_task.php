<?php
	class ControllerProductPostTask extends Controller {
		...
		public function index() {
			...
			if(isset($this->request->get['task_id'])){
				...
				$task = $this->model_account_task->getPostTask();
				if(empty($task)){
			...
			if (isset($this->request->get['product_id'])) {
				...
				if ($data['customer_creation_id']) {
					...
					$diydesign = $this->model_account_diy_design->getDiyTaskByDiyId($data['customer_creation_id']);
