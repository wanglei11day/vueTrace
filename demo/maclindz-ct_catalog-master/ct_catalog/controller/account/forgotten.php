...
class ControllerAccountForgotten extends Controller {
	...
	public function index() {
        ...
        $phone = is_numeric($this->request->post['email']);
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate($phone)) {
		    if($phone){
                $this->session->data['telephone'] = $this->request->post['email'];

                $this->response->redirect($this->url->link('account/phoneforgotten', '', 'SSL'));
            }else{
	...
	protected function validate($phone=false) {

	    if($phone){
            if (!isset($this->request->post['email'])) {
                $this->error['warning'] = $this->language->get('error_email');
            } elseif (!$this->model_account_customer->getTotalCustomersByTelephone($this->request->post['email'])) {
                $this->error['warning'] = $this->language->get('error_email');
            }
