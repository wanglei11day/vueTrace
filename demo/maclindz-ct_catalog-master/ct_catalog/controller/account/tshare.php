<?php
class ControllerAccountTShare extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            try {
                $this->sendProjectToFriend($this->request->post);
                $this->response->redirect($this->url->link('account/tshare/success'));
            } catch (Exception $e) {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('account/tshare', '', 'SSL')
		);
		...
		$data['action'] = $this->url->link('account/tshare', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/tshare.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/account/tshare.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/account/tshare.tpl', $data));
		}
	}
	...
	private function sendProjectToFriend($project_info){
				...
				$url=HTTP_SERVER.'tshirtecommerce/sharing.php?/'.$project_info[id];
	...
	public function success() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('account/tshare')
		);
