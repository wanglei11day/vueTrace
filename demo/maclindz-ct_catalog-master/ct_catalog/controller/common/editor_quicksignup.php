<?php
class ControllerCommonEditorQuicksignup extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/editor_quicksignup.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/editor_quicksignup.tpl', $data);
		} else {
			return $this->load->view('default/template/common/editor_quicksignup.tpl', $data);
		}
	}
	...
	public function register() {
		...
		if(!$json) {
			...
			$json['msg'] =  $this->language->get('text_register_success');
	...
	public function login() {
		...
		if(!$json) {
            ...
            $json['msg'] =  $this->language->get('text_login_success');
