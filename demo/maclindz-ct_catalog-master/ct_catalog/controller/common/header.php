...
class ControllerCommonHeader extends Controller {
	public function index() {
        ...
        if($this->config->get('config_custom_header_footer'))
        {
            $data['show_content'] = true;
        }
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/'.$headerlayout.'.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/'.$headerlayout.'.tpl', $data);
		} else {
