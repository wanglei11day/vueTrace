...
class ControllerCheckoutPaymentMethod extends Controller {
	public function index() {
		...
		if (isset($this->session->data['payment_address'])) {
            ...
            if($this->session->data['product_pay_code']){

                $data['paycode'] = $this->session->data['product_pay_code'];
            }else{
                $data['paycode'] = '';
            }
			$sort_order = array();
			...
			$this->load->model('extension/extension');
			$just_cod_payment = false;
			$recurring = $this->cart->hasRecurringProducts();
			if(bccomp($total,0,4)==0){
					$results = $this->model_extension_extension->getFreePayment('payment');
					foreach ($results as $result) {
		...
		$data['text_need_fapiao'] = $this->language->get('text_need_fapiao');
		$data['text_fapiao_title'] = $this->language->get('text_fapiao_title');
	...
	public function save() {
		...
		if (!$json) {
			...
			$this->session->data['fapiao'] = $this->request->post['fapiao'];
		}
