...
class ControllerCheckoutCheckout extends Controller {
	public function index() {
		...
		unset($this->session->data['product_pay_code']);
		$code = true;
        $paycode = '';
		...
		if($code)
        {
            $this->session->data['product_pay_code'] = $paycode;
        }
		...
		$data['text_checkout_hurry'] = $this->language->get('text_checkout_hurry');
	...
	public function checkorder(){
        ...
        if ($order_status_id&&$order_status_id == $this->config->get('weih5pay_order_status_id')) {
            echo 1;
        }else{
            echo 0;
        }
