...
function bindClickEvent() {
    ...
    $(".show-slider-panle").click(function (res) {
        ...
        $('.item-slider-content-c2-' + index + '').slideToggle();
        res.stopPropagation();
    });
    ...
    //model 11
    $("#vo_optEleven_cancel").on("click", function (res) {
        $('#vo-optEleven-modal').hide();
    });
    $("#vo_optEleven_confirm").on("click", function (res) {
        $('#vo-optEleven-modal').hide();
    });
    //model 12
    $("#vo_optTwelve_cancel").on("click", function (res) {
        $('#vo-optTwelve-modal').hide();
    });
    $("#vo_optTwelve_confirm").on("click", function (res) {
        $('#vo-optTwelve-modal').hide();
    });
    //model 13
    $("#vo_optThirteen_cancel").on("click", function (res) {
        $('#vo-optThirteen-modal').hide();
    });
    $("#vo_optThirteen_confirm").on("click", function (res) {
        $('#vo-optThirteen-modal').hide();
    });
    //model 14
    $("#vo_optFourteen_cancel").on("click", function (res) {
        $('#vo-optFourteen-modal').hide();
    });
    $("#vo_optFourteen_confirm").on("click", function (res) {
        $('#vo-optFourteen-modal').hide();
    });
    //model 15
    $("#vo_optFifteen_cancel").on("click", function (res) {
        $('#vo-optFifteen-modal').hide();
    });
    $("#vo_optFifteen_confirm").on("click", function (res) {
        $('#vo-optFifteen-modal').hide();
    });
