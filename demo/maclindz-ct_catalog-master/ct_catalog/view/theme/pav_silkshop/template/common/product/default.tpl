        ...
        <div class="bottom">
          <div class="action add-links clearfix">
             ...
             <?php if( !isset($listingConfig['catalog_mode']) || !$listingConfig['catalog_mode'] ) { ?>
              ...
              <div class="cart">    
              <?php if (isset($product['designable'])&&$product['designable']) { ?>
                <button data-loading-text="Loading..." class="btn-action" type="button" title="<?php echo $objlang->get('button_design'); ?>"  onclick="cart.design('<?php echo $product['product_id']; ?>');">
                 <i class="fa fa-pencil"></i><span class="hidden-sm hidden-md"><?php echo $button_diy; ?></span>
                </button>
                <?php } else { ?>
                 <button data-loading-text="Loading..." class="btn-action" type="button" title="<?php echo $objlang->get('button_cart'); ?>" onclick="cart.addcart('<?php echo $product['product_id']; ?>');">
