<?php $objlang = $this->registry->get('language'); $id = rand();  ?>
<?php if ($thumb || $images) { ?>
<div class="<?php echo $class; ?> image-container">
    <div class="row">
        ...
        <div class="product-share-review">
            <div class="rating">
                <p>

                    <span style="display: none;"><a  href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); goToByScroll('review');return false;"><?php echo $reviews; ?></a> / <a href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); goToByScroll('review');return false;"><?php echo $text_write; ?></a>
                    / </span><a data-toggle="tooltip" class="wishlist" title="<?php echo $button_wishlist; ?>" onclick="wishlist.addwishlist('<?php echo $product_id; ?>');"><i class="fa-fw fa fa-heart-o"></i><?php echo $button_wishlist; ?></a>
                </p>
