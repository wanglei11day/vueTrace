    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-telephone1"><?php echo $entry_email; ?></label>
            <div class="col-sm-6" id="email-telephone-reg">
              <input  name="email" value="<?php echo $telephone; ?>" placeholder="<?php echo $entry_email; ?>" id="input-telephone1" class="form-control" />
              <?php if ($error_email) { ?>
              <div class="text-danger"><?php echo $error_email; ?></div>
              <?php } ?>
            </div>
            <div id="send-code-reg" class="col-sm-4" style="display: none;">

              <div class="pull-right">
                <input type="submit" id="sendsnsverifycode" parent="account" value="<?php echo $button_sendverifycode; ?>" class="btn btn-primary" />
              </div>
            </div>
          </div>
          <div class="form-group required" id="verify-code-div1" style="display: none;">
            <label class="col-sm-2 control-label" for="input-phone-telephone"><?php echo $entry_verify_code; ?></label>
            <div class="col-sm-10">
              <input type="text" name="verify_code" value="<?php echo $verify_code; ?>" placeholder="<?php echo $entry_verify_code; ?>" id="input-phone-verify-code" class="form-control" />
              <?php if ($error_verify_code) { ?>
              <div class="text-danger"><?php echo $error_verify_code; ?></div>
              <?php } ?>
            </div>
...
<script type="text/javascript">
    ...
    $('#sendsnsverifycode').on('click', function(e) {
        ...
        var telephone = $("#"+parent+" #input-telephone1").val();
        var node = this;
    ...
    $("#input-telephone1").on('blur',function(e){
        et = $("#input-telephone1").val();
        et = et.replace(/(^\s*)|(\s*$)/g, "");
        if(et==''){
            return;
        }
        if(et.indexOf("@")>-1){
            $("#email-telephone-reg").removeClass();
            $("#email-telephone-reg").addClass("col-sm-10");
            $("#send-code-reg").hide();
            $("#verify-code-div1").hide();
        }else{
            $("#email-telephone-reg").removeClass();
            $("#email-telephone-reg").addClass("col-sm-6");
            $("#send-code-reg").show();
            $("#verify-code-div1").show();
            if(!isNumber1(et)){
    ...
    $('#button_register').on('click', function(e) {
        e.preventDefault();
        var node = this;
        if($("#input-confirm").val()==''||$("#input-password-1").val()==''){
            alert("<?php echo $error_password_empty;?>");
            return false;
        }

        if($("#input-confirm").val()!=$("#input-password-1").val()){
            alert("<?php echo $error_password_notequal;?>");
            return false;
        }

        if($("#input-firstname").val()==''){
            alert("<?php echo $error_firstname;?>");
            return false;
        }
        ...
        $.ajax({
            url: 'index.php?route=tool/api/register',
            type: 'post',
            dataType: 'json',
            ...
            success: function(json) {
                if (json['status']!=1) {
                    ...
                    if(json['redirect']!=''){
                        ...
                        location = "<?php echo $success_redirect;?>";
                    }
