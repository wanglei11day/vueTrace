    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <h1 id="task-title"><?php echo $text_task_book; ?></h1>
       ...
       <div class="clearfix tabs-group" style="padding: 0px;">
        <ul class="nav nav-tabs" role="tablist">
            <li class="<?php echo $mytask_class;?>"><a href="<?php echo $mytask;?>" ><?php echo $text_my_task;?></a></li>
            <li class="<?php echo $myposttask_class;?>"><a href="<?php echo $myposttask;?>" ><?php echo $text_my_post_task;?></a></li>
            <li class="<?php echo $myhistorytask_class;?>"><a href="<?php echo $myhistorytask;?>" ><?php echo $text_my_history_task;?></a></li>
      ...
      <div  class="row task-tag">
         <?php foreach ($tags as $tag) { ?>
             <div class="col-xs-6 col-sm-4  col-md-1 task-tags">
                <div class="<?php echo $tag['tagclass'];?>">
