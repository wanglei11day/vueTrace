<div class="list-group">
  ...
  <?php if ($text_link_to_affiliate) { ?> 
  <a href="<?php echo $link_to_affiliate; ?>" class="list-group-item"><?php echo $text_link_to_affiliate; ?></a><?php } ?>
  <?php if ($affiliate_logged) { ?> 
  <a href="<?php echo $affiliate_account; ?>" class="list-group-item"><?php echo $text_affiliate_account; ?></a> 
  <a href="<?php echo $affiliate_info; ?>" class="list-group-item"><?php echo $text_affiliate_info; ?></a> 
  <a href="<?php echo $affiliate_tracking; ?>" class="list-group-item"><?php echo $text_affiliate_tracking; ?></a> 
  <a href="<?php echo $affiliate_transaction; ?>" class="list-group-item"><?php echo $text_affiliate_transaction; ?></a><?php } ?>  
  <?php if ($logged) { ?>
