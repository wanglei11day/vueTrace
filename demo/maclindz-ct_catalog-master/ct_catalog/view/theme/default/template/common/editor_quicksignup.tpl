<div id="modal-quicksignup" class="modal" style="">
		...
		<div class="modal-body product-info">
			...
			<div class="clearfix box-product-infomation tab-v3">
				<ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="active tab-login"><a href="#quick-login" data-toggle="tab"><?php echo $text_login;?></a></li>
                    <li class="tab-register"><a href="#quick-register" data-toggle="tab"><?php echo $text_register;?></a></li>
				...
				<div class="tab-content text-left">
					<div class="tab-pane active" id="quick-login">
						...
						<div class="form-group required">
							...
							<input type="text" name="email" value=""  id="input-email" class="form-control fix-input" />
						</div>
						<div class="form-group required">
							<label class="control-label" for="input-password"><?php echo $entry_password; ?></label>
							<input type="password" name="password" value="" id="input-password" class="form-control fix-input" />
						</div>
					...
					<div class="tab-pane" id="quick-register">
						...
						<div class="form-group required">
							...
							<input type="text" name="name" value="" id="input-name" class="form-control fix-input" />
						</div>
						...
						<div class="form-group required">
							...
							<div class="row" style="margin: 0px;">
								<div id="email_telephone" class="col-xs-12 col-md-12" style="width: 60%">
									<input type="text" name="email"  value="" id="input-telephone" class="form-control fix-input" />
								</div>
						...
						<div class="form-group required" id="verify-code-div" style="display: none;">
							...
							<input type="text" name="verify_code" value="" id="input-verify-code" class="form-control fix-input" />
						</div>
						<div class="form-group required">
							<label class="control-label" for="input-password"><?php echo $entry_password; ?></label>
							<input type="password" name="password" value="" id="register-input-password" class="form-control fix-input" />
						</div>
						<div class="form-group required">
							<label class="control-label" for="input-comfirm-password"><?php echo $entry_comfirm_password; ?></label>
							<input type="password" name="comfirm" value="" id="register-input-comfirm-password" class="form-control fix-input" />
						</div>
						<?php if ($text_agree) { ?>
						<div class="buttons">
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$.ajax({
						url: 'index.php?route=account/diydesign/editor_login_success',
						type: 'get',
						dataType: 'json',
						beforeSend: function() {
						},
